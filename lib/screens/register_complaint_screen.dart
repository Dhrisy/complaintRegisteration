...
//     if (selectedDepartment == null || _nameController.text.isEmpty || _locationController.text.isEmpty) {
...
//       'complaint': complaintText.isNotEmpty ? complaintText : _customComplaintController.text,
//       'status': 'Pending',
//       'timestamp': Timestamp.now(),
//     });

//     ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Complaint Registered Successfully")));
...
//               items: complaintTemplates.keys.map((dept) {
...
//               Text("Select Complaint Type", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
//               DropdownButton<String>(
//                 isExpanded: true,
//                 value: selectedTemplate,
//                 hint: Text("Choose Complaint Type"),
//                 items: complaintTemplates[selectedDepartment]!.map((complaint) {
//                   return DropdownMenuItem(value: complaint, child: Text(complaint));
//                 }).toList(),
//                 onChanged: (value) {
//                   setState(() {
//                     selectedTemplate = value;
//                     complaintText = "Complaint about $value in $_locationController.text.";
//                   });
//                 },
//               ),
//               SizedBox(height: 10),
...
//                 decoration: InputDecoration(labelText: "Describe Your Complaint", border: OutlineInputBorder()),
//                 maxLines: 3,
//               ),
...
//               child: Text("Register Complaint", style: TextStyle(fontSize: 18)),
//             ),
//           ],
//         ),
//       ),
        ...
        children: [
          ...
          const SizedBox(height: 16),
           _buildDropdown(
              ...
              items: (complaintTemplates[selectedDepartment] ?? [])
                  .map((complaint) {
                return DropdownMenuItem(
                  value: complaint,
