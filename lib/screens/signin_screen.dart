...
//           Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => OfficerHomeScreen()));
//         } else {
...
//       // Check if the email exists in any of the collections before authentication
//       QuerySnapshot adminQuery = await _firestore.collection('admins').where('email', isEqualTo: email).get();
//       QuerySnapshot officerQuery = await _firestore.collection('officers').where('email', isEqualTo: email).get();
...
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(
//             content: const Text("Sign-in failed: Email not registered."),
//             backgroundColor: Colors.red.shade400,
//             behavior: SnackBarBehavior.floating,
//           ),
//         );
...
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(
//             content: const Text("Sign-in failed: Invalid credentials."),
//             backgroundColor: Colors.red.shade400,
//             behavior: SnackBarBehavior.floating,
//           ),
//         );
...
//       // Navigate based on _selectedRole
